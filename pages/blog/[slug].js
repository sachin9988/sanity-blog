    ...
    <div>
      <div className="w-full z-50 top-0 py-3 sm:py-5  bg-primary ">
        <div className="container flex items-center justify-between">
          <div>
            <Link href="/">
              <Image height={""} width={""} src="/assets/img/logo.svg" className="w-24 lg:w-48" alt="logo image" />
            </Link>
          </div>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="">
            ...
            <div className="flex items-center pt-5 md:pt-10">
              <div>
                <Image height={""} width={""} src="/assets/img/blog-author.jpg"
    ...
    />
          ...
          <div
            ...
            <div className="w-3/4 sm:w-2/5 lg:w-1/4 xl:w-1/5">
              <Image height={""} width={""} src="/assets/img/blog-author.jpg" className="rounded-full shadow" alt="author image" />
            </div>
